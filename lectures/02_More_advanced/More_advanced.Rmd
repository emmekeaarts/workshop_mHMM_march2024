...
On these pseudo residuals, we can do the usual residual checking: e.g., normality, heteroscedasticity, lack of trend over time. Most informative at the subject level: does the model fit each subject specifically? 
